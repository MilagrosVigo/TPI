...
$category = isset($_GET['category']) ? $_GET['category'] : 'Perfume';
...
<body>
    ...
    <main class="main-content">
        ...
        <div class="container-options">
            <a href="?category=Perfume" class="category_item">Todo</a>
            <a href="?category=Femenino" class="category_item">Femenino</a>
            <a href="?category=Masculino" class="category_item">Masculino</a>
            <a href="?category=Unisex" class="category_item">Unisex</a>
        </div>
